...
query_dict = url.parse_qs(query_str)
...
relative = "/users/123"
joined = url.urljoin(base, relative)
print("Joined '" + base + "' + '" + relative + "' = '" + joined + "'")

# urlsplit
print("\n--- URL Splitting ---")
split_parts = url.urlsplit("https://example.com/path?query=value#fragment")
...
unsplit_url = url.urlunsplit(parts)
